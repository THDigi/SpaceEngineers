...
namespace Sandbox.ModAPI.Interfaces
{
    ...
    {
        public static Dictionary<MyControlsEnum, MyStringId> enumValues = new Dictionary<MyControlsEnum, MyStringId>();

        static MyControls()
        {
            enumValues.Add(MyControlsEnum.FORWARD, MyStringId.GetOrCompute("FORWARD"));
            enumValues.Add(MyControlsEnum.BACKWARD, MyStringId.GetOrCompute("BACKWARD"));
            enumValues.Add(MyControlsEnum.STRAFE_LEFT, MyStringId.GetOrCompute("STRAFE_LEFT"));
            enumValues.Add(MyControlsEnum.STRAFE_RIGHT, MyStringId.GetOrCompute("STRAFE_RIGHT"));
            enumValues.Add(MyControlsEnum.ROLL_LEFT, MyStringId.GetOrCompute("ROLL_LEFT"));
            enumValues.Add(MyControlsEnum.ROLL_RIGHT, MyStringId.GetOrCompute("ROLL_RIGHT"));
            enumValues.Add(MyControlsEnum.SPRINT, MyStringId.GetOrCompute("SPRINT"));
            enumValues.Add(MyControlsEnum.PRIMARY_TOOL_ACTION, MyStringId.GetOrCompute("PRIMARY_TOOL_ACTION"));
            enumValues.Add(MyControlsEnum.SECONDARY_TOOL_ACTION, MyStringId.GetOrCompute("SECONDARY_TOOL_ACTION"));
            enumValues.Add(MyControlsEnum.JUMP, MyStringId.GetOrCompute("JUMP"));
            enumValues.Add(MyControlsEnum.CROUCH, MyStringId.GetOrCompute("CROUCH"));
            enumValues.Add(MyControlsEnum.SWITCH_WALK, MyStringId.GetOrCompute("SWITCH_WALK"));
            enumValues.Add(MyControlsEnum.USE, MyStringId.GetOrCompute("USE"));
            enumValues.Add(MyControlsEnum.TERMINAL, MyStringId.GetOrCompute("TERMINAL"));
            enumValues.Add(MyControlsEnum.HELP_SCREEN, MyStringId.GetOrCompute("HELP_SCREEN"));
            enumValues.Add(MyControlsEnum.CONTROL_MENU, MyStringId.GetOrCompute("CONTROL_MENU"));

            enumValues.Add(MyControlsEnum.ROTATION_LEFT, MyStringId.GetOrCompute("ROTATION_LEFT"));
            enumValues.Add(MyControlsEnum.ROTATION_RIGHT, MyStringId.GetOrCompute("ROTATION_RIGHT"));
            enumValues.Add(MyControlsEnum.ROTATION_UP, MyStringId.GetOrCompute("ROTATION_UP"));
            enumValues.Add(MyControlsEnum.ROTATION_DOWN, MyStringId.GetOrCompute("ROTATION_DOWN"));
            enumValues.Add(MyControlsEnum.HEADLIGHTS, MyStringId.GetOrCompute("HEADLIGHTS"));
            //enumValues.Add(MyControlsEnum.SCREENSHOT, MyStringId.GetOrCompute("SCREENSHOT"));
            enumValues.Add(MyControlsEnum.LOOKAROUND, MyStringId.GetOrCompute("LOOKAROUND"));
            enumValues.Add(MyControlsEnum.SWITCH_LEFT, MyStringId.GetOrCompute("SWITCH_LEFT"));
            enumValues.Add(MyControlsEnum.SWITCH_RIGHT, MyStringId.GetOrCompute("SWITCH_RIGHT"));
            enumValues.Add(MyControlsEnum.CUBE_COLOR_CHANGE, MyStringId.GetOrCompute("CUBE_COLOR_CHANGE"));
            enumValues.Add(MyControlsEnum.TOGGLE_REACTORS, MyStringId.GetOrCompute("TOGGLE_REACTORS"));
    ...
    /*
    /// <summary>
    /// Controls usable in Programmable Block scripting
    /// </summary>
    public class MyControls
    {
        ...
        public static List<MyStringId> List = new List<MyStringId>();

        static MyControls()
        {
            List.Clear();

            foreach (var field in typeof(MyControls).GetFields())
            {
                List.Add((MyStringId)field.GetValue(typeof(MyControls)));
            }
        }
    }
     */
